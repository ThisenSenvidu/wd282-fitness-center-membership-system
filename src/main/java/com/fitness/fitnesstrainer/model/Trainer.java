...
public abstract class Trainer {
    ...
    public String getTypeLabel() { return "Trainer"; }

    // Static method
    public static int getTrainerCount() { return trainerCount; }

    // Convert trainer to one pipe-separated line for saving to file
    ...
    public void   setTrainerType(String t)            { this.trainerType = t; }
