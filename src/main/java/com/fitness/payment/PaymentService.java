...
public class PaymentService {package com.fitness.fitnesstrainer.service;
...
import java.util.ArrayList;
    ...
    /**
     * PaymentService.java — Business logic layer for Payment Management.
     *
     * Spring Boot concept:
     *   @Service — Spring manages this as a bean; injected into PaymentController
     *
     * OOP concepts:
     *   Encapsulation — hides file-handling details from the controller
     *   Polymorphism  — builds CashPayment or CardPayment based on paymentType
     */
    @Service
